...
class RechuteTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->calculator = new IJCalculator(__DIR__ . '/../data/taux.csv');
    }

    // Rechute Detection Tests

    public function testShouldIdentifyRechuteWhenNewArretStartsWithin1YearOfPreviousArretEnd(): void
    {
        $data = [
            'arrets' => [
                [
        ...
        $result = $this->calculator->calculateAmount($data);

        // Rechute should have payment starting from 15th day, not 91st
        $this->assertArrayHasKey('arrets', $result);
        $this->assertEquals(2, count($result['arrets']));
    }

    public function testShouldNotBeRechuteWhenArretStartsMoreThan1YearAfterPrevious(): void
    {
        $data = [
            'arrets' => [
                [
    ...
    public function testShouldRecognizeRechuteAtExactly1YearMinus1DayBoundary(): void
    {
        $data = [
            'arrets' => [
                [
    ...
    // Rechute Date d'Effet Rules Tests

    public function testShouldApply15DayRuleForRechuteInsteadOf91DayRule(): void
    {
        ...
        $this->assertArrayHasKey('nb_jours', $result);
    }

    public function testShouldApply15DayPenaltyForLateDeclarationOnRechuteNot31Days(): void
    {
    ...
    public function testShouldApply15DayPenaltyForGpmAccountUpdateOnRechute(): void
    {
    ...
    // Rechute vs Prolongation Distinction Tests

    public function testShouldTreatConsecutiveArretsAsProlongationNotRechute(): void
    {
    ...
    // Rechute Cumulative Days Calculation Tests

    public function testShouldCumulateDaysFromPreviousArretsForRechute(): void
    {
        $data = [
            'arrets' => [
                [
        ...
        $this->assertArrayHasKey('total_cumul_days', $result);
        $this->assertGreaterThan(90, $result['total_cumul_days']);
    }

    public function testShouldHandleMultipleRechutesInSamePathology(): void
    {
        $data = [
            'arrets' => [
                [
