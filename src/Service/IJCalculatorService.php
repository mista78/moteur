...
{
    /**
     * @var array<int, array<string, mixed>> Rates data loaded from CSV
     */
    private array $rates = [];

    /**
     * @var float PASS value (Plafond Annuel de la Sécurité Sociale)
     */
     ...
     * Constructor
     *
     * @param string $csvPath Path to CSV rates file
     * @throws \RuntimeException If CSV file not found
     */
     ...
     *
     * @param int $year Year
     * @return array<string, mixed>|null Rate data or null if not found
     */
     ...
     */
    public function determineClasse(?float $revenuNMoins2 = null, ?string $dateOuvertureDroits = null, bool $taxeOffice = false): string
    {
