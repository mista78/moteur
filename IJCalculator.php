...
use App\IJCalculator\Services\DateCalculationInterface;
use App\IJCalculator\Services\DateService;
use App\IJCalculator\Services\RateService;
use App\IJCalculator\Services\RateServiceInterface;
use App\IJCalculator\Services\TauxDeterminationInterface;
...
class IJCalculator {
	 ...
	 *
	 * @param array $csvPath Liste des taux
	 * @param \App\IJCalculator\Services\RateServiceInterface|null $rateService Service de taux optionnel (pour les tests/mocks)
	 * @param \App\IJCalculator\Services\DateCalculationInterface|null $dateService Service de dates optionnel (pour les tests/mocks)
	 * @param \App\IJCalculator\Services\TauxDeterminationInterface|null $tauxService Service de taux optionnel (pour les tests/mocks)
	 * @param \App\IJCalculator\Services\AmountCalculationInterface|null $amountService Service de calcul de montants optionnel (pour les tests/mocks)
	 */
	 ...
	 * @return void
	 */
	private function loadRates($rates) {
		$this->rates = $rates;
	}
